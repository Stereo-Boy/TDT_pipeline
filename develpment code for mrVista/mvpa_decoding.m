...
% script to apply mvpa on brain images using the TDT and mrVista
% IMPORTANT NOTE: atm, this code does not respect the 3D natture of the structure
% of the brain (it is treated as a long list of numbers and therefore,
% searchlight does not make sense in that context)
%
